...
impl NativeFunction {
    fn from_name(name: &str) -> Option<Self> {
        Some(match name {
            ...
            "playerSetSubtitleStyle" => Self::PlayerSetSubtitleStyle,
            ...
            "updateDownload" => Self::UpdateDownload,
            "updateInstall" => Self::UpdateInstall,
    ...
    pub(crate) fn name(self) -> &'static str {
        match self {
            ...
            Self::PlayerSetSubtitleStyle => "playerSetSubtitleStyle",
            ...
            Self::UpdateDownload => "updateDownload",
            Self::UpdateInstall => "updateInstall",
...
const WEB_FUNCTIONS: &[NativeFunction] = &[
    ...
    NativeFunction::PlayerSetSubtitleStyle,
